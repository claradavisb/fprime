...
module Ccsds {
    ...
    interface CcsdsSdlsEncrypt {
        ...
        @ Sync (not guarded): in the synchronous SDLS pipeline the buffer sent on encryptOut
        @ is returned here while encryptIn is still on the stack, i.e. while this component's
